		...
		<div class="mp-painel-body">
			<form action="" method="post" class="mp-login-form mp-form">
				...
				<div class="mp-row">
					<div class="mp-col">
						<div class="mp-form-group">
							...
							value="<?= ($_SESSION['cadastroSocial'] != null) ? '_' : ''; ?>" 
							placeholder="<?= $data['formulario_senha_placeholder']?>" 
							<?= ($_SESSION['cadastroSocial'] != null ) ? 'disabled' : ''; ?> />
						</div>
					</div>
					<div class="mp-col">
						<div class="mp-form-group">
							<label class="mp-label"><?= $data['formulario_senha_confirmacao']?></label>
							<input class="mp-input" type="password" name="confirm-password" 
							value="<?= ($_SESSION['cadastroSocial'] != null) ? '_' : ''; ?>" 
				...
				<div class="mp-checkbox-group mp-itens-center" style="margin: 5% 0">
					<button type="submit" class="mp-btn mp-btn-primary" id="submitButton"><?= $data['formulario_botao']?></button>
				</div>	
			</form>
		</div>
	</div>
